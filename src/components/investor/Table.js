...
const rows = [
  createData('Vardhman textiles', 10000, 20000, 100),
  createData('Reliance industries', 500, 1000, 100),
  createData('State Bank Of India', 50000, 100000, 100),
  createData('Rupa brands', 1000, 500, -50),
  createData('Skyroot Aerospace',100000,300000,200 ),
];
